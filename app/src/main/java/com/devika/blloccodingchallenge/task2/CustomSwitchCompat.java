package com.devika.blloccodingchallenge.task2;
...
public class CustomSwitchCompat extends CompoundButton {
    private static final int THUMB_ANIMATION_DURATION = 500;
    ...
    private static final Property<CustomSwitchCompat, Float> THUMB_POS =
            new Property<CustomSwitchCompat, Float>(Float.class, "thumbPos") {
                ...
                @Override
                public void set(CustomSwitchCompat object, Float value) {
